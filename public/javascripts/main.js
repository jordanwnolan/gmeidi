...
(function() {
  var TEMPLATES, applicationRequested, bindClickHandlers, bindHandlers, bindScrollHandlers, nextPhaseHandlers, nextQuestionHandlers, notFinalYearQuoteSuccess, questionSubmitHandler, quoteSuccessHandler, requestApplicationHandler, showPlanHandler;
  ...
  quoteSuccessHandler = function(data) {
    ...
    if (data['amounts'].length === 1) {
      return notFinalYearQuoteSuccess(data);
    } else {
  ...
  notFinalYearQuoteSuccess = function(data) {
    var el;
    $(".plan_buttons").html(TEMPLATES['button']({
      n: 2,
      'plan-level': 2000
