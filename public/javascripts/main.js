...
(function() {
  var bindClickHandlers, bindHandlers, nextPhaseHandlers, nextQuestionHandlers, questionSubmitHandler, quoteSuccessHandler, showPlanHandler;
  ...
  quoteSuccessHandler = function(data) {
    ...
    return $("#3k_selection_cost").html("$" + data['amounts'][0]);
  };
